...
export const Login = () => {
  ...
  async function handleLogin(event) {
    ...
    try {
      ...
      toast.error(`Login Error: ${error.status} ${error.message}`, {
  ...
  async function handleLoginGuest() {
    email.current.value = process.env.REACT_APP_GUESTEMAIL;
    password.current.value = process.env.REACT_APP_GUESTPASSWORD;
