          ...
          <div className="flex items-center relative">
            {darkMode ? (
              <span
                ...
                className="dark:text-white cursor-pointer text-xl text-gray-700 mr-5 bi bi-sun"
              ></span>
            ) : (
              <span
                onClick={() => SetDarkMode(!darkMode)}
                className="cursor-pointer text-xl text-gray-700 dark:text-white mr-5 bi bi-moon"
              ></span>
            )}
